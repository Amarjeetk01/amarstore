import{r as i,$ as p,_ as $,j as u,h as v}from"./index-CFi3jwE8.js";const c="horizontal",x=["horizontal","vertical"],s=i.forwardRef((e,r)=>{const{decorative:o,orientation:t=c,...a}=e,n=d(t)?t:c,l=o?{role:"none"}:{"aria-orientation":n==="vertical"?n:void 0,role:"separator"};return i.createElement(p.div,$({"data-orientation":n},l,a,{ref:r}))});s.propTypes={orientation(e,r,o){const t=e[r],a=String(t);return t&&!d(t)?new Error(h(a,o)):null}};function h(e,r){return`Invalid prop \`orientation\` of value \`${e}\` supplied to \`${r}\`, expected one of:
  - horizontal
  - vertical
